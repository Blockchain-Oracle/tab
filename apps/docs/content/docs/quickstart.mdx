...
Open your storefront in test mode and pay with any email. An empty wallet can
...
receiving address) before enabling live mode. Test keys never move real funds.
